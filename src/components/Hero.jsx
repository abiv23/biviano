...
}) 
{
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#111111]">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/60 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Crafting personalized websites for local businesses.
            </p>
          </motion.div>
        </div>
      </div>
