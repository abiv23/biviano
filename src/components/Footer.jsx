      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 md:text-right">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider mb-4" style={{ fontFamily: "var(--font-outfit)" }}>
              Services
            </h3>
            <ul className="space-y-2">
              {[{name: "About", link: '/about'}, {name: "Design", link: '/web-design'}, {name: "SEO", link: '/seo'}].map((item, i) => (
                <li key={i}>
                  <Link 
                    href={item.link}
          ...
          <div className="md:col-span-1 md:text-right">
            ...
            <div className="flex md:justify-end space-x-5 mb-6">
              {/* Social icons */}
              <a href="https://github.com/abiv23" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/abiv23/" target="_blank" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
